...
define([
    ...
    var ResultPathCollection = Backbone.Collection.extend({
        ...
        url: function () {
            var url = App.config.apiEndPoint + '/workspaces/' + App.config.workspaceId + '/products/' + App.config.productId + '/paths?configSpec='+App.config.productConfigSpec+'&search=' + encodeURIComponent(this.searchString);
