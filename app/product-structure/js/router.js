    ...
    function (Backbone, singletonDecorator) {
        ...
        var Router = Backbone.Router.extend({
            ...
            defaults: function (workspaceId, productId, configSpecType) {
                ...
                this.navigate(encodeURIComponent(workspaceId) + '/' + encodeURIComponent(productId) + '/config-spec/' + encodeURIComponent(configSpecType) + '/scene', {trigger: true});
            },
            ...
            updateRoute: function (context) {
                ...
                if (!App.collaborativeView.roomKey) {
                    ...
                    this.navigate(
                        encodeURIComponent(App.config.workspaceId) + '/' + encodeURIComponent(App.config.productId) +
                        '/config-spec/' + encodeURIComponent(App.config.productConfigSpec) +
                        '/scene/camera/' +
