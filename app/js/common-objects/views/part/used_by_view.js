    ...
    var UsedByView = Backbone.View.extend({
        ...
        render:function(){
            ...
            if(this.linkedPart){
                ...
                $.ajax({
                    type:'GET',
                    url: App.config.apiEndPoint + '/workspaces/' + App.config.workspaceId + '/parts/' + this.linkedPart.getPartKey() + '/used-by-as-component',
                ...
                $.ajax({
                    type:'GET',
                    url: App.config.apiEndPoint + '/workspaces/' + App.config.workspaceId + '/parts/' + this.linkedPart.getPartKey() + '/used-by-as-substitute',
                    contentType:'application/json',
                    success:function(parts){
                        _.each(parts, function(part){
                            var newPartModel = new Part(part);
