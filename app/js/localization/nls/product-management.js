...
define({
    root: {
        CONFIRM_DELETE_BASELINE:'Do you want to delete the selected baselines?',
        CONFIRM_DELETE_PART:'Do you want to delete the selected parts?',
        CONFIRM_DELETE_PART_EFFECTIVITY: 'Do you want to delete the selected part effectivity?',
        CONFIRM_DELETE_PART_TEMPLATE:'Do you want to delete the selected part templates?',
        CONFIRM_DELETE_PRODUCT:'Do you want to delete the selected products?',
        CONFIRM_DELETE_CONFIGURATION:'Do you want to delete the selected configurations?',
        CONFIRM_DELETE_PRODUCT_INSTANCE:'Do you want to delete the selected product instances?',
        CREATE_BASELINE_LATEST: 'Create baseline with the latest parts',
        CREATE_BASELINE_RELEASED: 'Create baseline with the latest released parts',
