...
define([
    ...
    'views/login-scene'
], function (Backbone, Mustache, template, LoginFormView, RecoveryFormView, RecoverFormView, LoginWithView, AccountCreationFormView, LoginSceneView) {
    'use strict';
    ...
    var AppView = Backbone.View.extend({
        ...
        showLoginWith: function () {
            this.$FormContainer.html(new LoginWithView().render().$el);
            this.$FormContainer.attr('class', 'put-right');
            this.sceneView.handleResize();
        },
