    ...
    var ProductListItemView = Backbone.View.extend({
        ...
        render: function () {
            ...
            this.$('.download-zip').popover({
                ...
                html: true,
                trigger: 'manual',
                content: '<a data-file-download-output=".zip" data-file-download="'+(zipUrl+ '&exportNativeCADFiles=true&exportDocumentLinks=false')+'">'+App.config.i18n.CAD_FILE+'</a> | ' +
                '<a data-file-download-output=".zip" data-file-download="'+(zipUrl+ '&exportNativeCADFiles=false&exportDocumentLinks=true')+'">'+App.config.i18n.LINKS+'</a> | ' +
                '<a data-file-download-output=".zip" data-file-download="'+(zipUrl+ '&exportNativeCADFiles=true&exportDocumentLinks=true')+'">'+App.config.i18n.EVERYTHING+'</a>',
                placement: 'top'
            }).click(function (e) {
                $(this).popover('show');
                e.stopPropagation();
