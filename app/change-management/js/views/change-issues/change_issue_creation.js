...
define([
    ...
    function (Backbone, Mustache, template, ChangeIssueModel, UserList, LinkedDocumentsView, LinkedDocumentCollection, LinkedPartsView, LinkedPartCollection, AlertView) {
        'use strict';
